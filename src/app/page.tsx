    ...
    <div className="grid grid-cols-1 gap-20 lg:gap-40">
      <div className="flex flex-col md:flex-row items-center gap-10">
        <div className="md:w-3/5 grid grid-cols-1 gap-5 lg:gap-10">
          ...
          <div className="flex gap-2 sm:gap-5 text-xs lg:text-base font-medium">
            <a className="py-2 px-4 lg:py-3 lg:px-6 flex items-center gap-1 sm:gap-2 text-center text-grayprimary border border-current hover:text-black hover:bg-white hover:border-white rounded-4xl" href={"/Resume - Caio Vinicius.pdf"} download>
              Download my Resume
            ...
            <Link className="p-3 lg:p-4 flex items-center text-grayprimary border border-current hover:text-black hover:bg-white hover:border-white rounded-full" href={"https://www.linkedin.com/in/caioviniciusml/"} target="_blank">
            ...
            <Link className="p-3 lg:p-4 flex items-center text-grayprimary border border-current hover:text-black hover:bg-white hover:border-white rounded-full" href={"https://github.com/caioviniciusml"} target="_blank">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
