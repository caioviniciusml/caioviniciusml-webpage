...
export default function Home() {
  ...
  const text = "Building high-performance web experiences that are both visually stunning and strategically optimized. No more trade-offs—let’s create solutions that engage users and drive results!"
  ...
  return (
    <div className="grid grid-cols-1 gap-20 lg:gap-40">
      <div className="flex flex-col md:flex-row items-center gap-10">
        <div className="md:w-3/5 grid grid-cols-1 gap-5 lg:gap-10">
          <h1 className="text-grayprimary text-3xl sm:text-4xl lg:text-6xl xl:text-7xl">
            <b className="text-white">A Full Stack Software Engineer</b> building modern web applications
          </h1>
          <div className="flex gap-4 sm:gap-5 text-xs lg:text-base font-semibold">
            <Link className="py-2 px-4 lg:py-3 lg:px-6 flex items-center gap-2 text-center text-grayprimary border border-current hover:text-black hover:bg-white hover:border-white rounded-2xl" href={"/Resume - Caio Vinicius.pdf"} target="_blank" download="Resume - Caio Vinicius.pdf">
              Download my Resume
            ...
            <Link className="p-3 lg:p-4 flex items-center text-grayprimary border border-current hover:text-black hover:bg-white hover:border-white rounded-2xl" href={"https://www.linkedin.com/in/caioviniciusml/"} target="_blank">
            ...
            <Link className="p-3 lg:p-4 flex items-center text-grayprimary border border-current hover:text-black hover:bg-white hover:border-white rounded-2xl" href={"https://github.com/caioviniciusml"} target="_blank">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="flex justify-center text-center text-lg sm:text-xl md:text-2xl lg:text-4xl">
        <p className="md:w-3/4 inline-block text-transparent bg-gradient-to-r to-80% from-[#1E1E22] to-white bg-clip-text">
          {displayedText}
        </p>
      </div>
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start text-grayprimary gap-16 lg:gap-32">
        ...
        <div className="md:w-1/2 grid grid-cols-1 gap-5 text-justify text-grayprimary text-base lg:text-xl order-1 md:order-2">
          ...
          <p>I’m Caio Vinícius, a Full Stack Software Engineer with a passion for crafting seamless digital experiences. With a strong foundation in UI/UX and modern web technologies, I specialize in designing and developing fast, scalable, and conversion-driven web applications.</p>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-10 sm:gap-0">
        <div className="flex items-center gap-2 lg:gap-5">
          <span className="text-4xl sm:text-6xl xl:text-8xl">+2</span>
          <span className="text-xl sm:text-base md:text-lg lg:text-3xl xl:text-4xl font-medium text-grayprimary">YEARS OF <br className="hidden sm:block" /> EXPERIENCE</span>
        </div>
        <div className="flex items-center gap-2 lg:gap-5">
          <span className="text-4xl sm:text-6xl xl:text-8xl">+2</span>
          <span className="text-xl sm:text-base md:text-lg lg:text-3xl xl:text-4xl font-medium text-grayprimary">YEARS AS <br className="hidden sm:block" /> FRONT-END</span>
        </div>
        <div className="flex items-center gap-2 lg:gap-5">
          <span className="text-4xl sm:text-6xl xl:text-8xl">+1</span>
          <span className="text-xl sm:text-base md:text-lg lg:text-3xl xl:text-4xl font-medium text-grayprimary">YEARS AS <br className="hidden sm:block" /> BACK-END</span>
        </div>
      </div>
      <div className="flex flex-col items-center gap-10">
        <h2 className="py-2 px-4 text-base md:text-xl font-semibold bg-graythird rounded-3xl">Tech Stacks</h2>
